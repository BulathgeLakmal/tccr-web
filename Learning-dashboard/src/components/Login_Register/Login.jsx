    ...
    return (
        <div className='flex items-center justify-center w-full min-h-screen'>
            ...
            <div className='flex flex-col items-center rounded-md bg-blue bg-opacity-50 w-[400px] h-[400px] min-[320px]:mx-2'>
                ...
                <form className='py-2'>
                    <div>
                        <input
                            ...
                            className='flex pl-2 py-2 bg-transparent border-2 rounded-lg text-white outline-none text-[12px] font-filson'
                        />
                    </div>
                    <div>
                        <input
                            ...
                            className='flex pl-2 mt-4 py-2 bg-transparent border-2 rounded-lg text-white outline-none text-[12px] font-filson'
                        />
                    </div>
                    <div>
                        <button
                            onClick={handleSubmit}
                            className='flex items-center justify-center pl-2 mt-8 py-2 bg-blue rounded-lg text-white w-full text-[14px] font-filson'
                        >
                            {userData.role === 'user' && loading && (
                                <Link to="/home"><h3>SIGN IN</h3></Link>
                            )}

                            {userData.role === 'admin' && loading && (
                                <Link to="/updateCourse"><h3>SIGN IN</h3></Link>
                            )}
                ...
                <div className='pt-8'>
                    <div>
                        <p className='flex font-filson text-[13px] text-white'>
                            Don't have an account? <span className='pl-1 cursor-pointer'>Create an Account</span>
                        </p>
                        <br />
                    </div>
                    <div>
                        <Link to='/register'>
                            <span className='flex items-center justify-center text-[16px] text-blue cursor-pointer mt-[-15px]'>Register</span>
                        </Link>
                    </div>
